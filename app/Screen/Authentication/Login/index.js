            ...
            >
                <View style={styles.alertBackground}>
                    <View style={styles.alertBox}>
                        <TouchableOpacity onPress={() => setActiveModal(false)} style={{ position: 'absolute', right: 20, top: 10, width: 40, alignItems: 'flex-end' }}>
                            <Text style={{ fontFamily: FONT_FAMILY_TYPE_WRITER, fontSize: 20 }}>X</Text>
                        </TouchableOpacity>
                        <Text style={{ fontFamily: FONT_FAMILY_TYPE_WRITER, fontSize: 18, paddingTop: 20 }}>User is inactive by admin</Text>
                    </View>
                </View>
            </Modal>
        </View>
