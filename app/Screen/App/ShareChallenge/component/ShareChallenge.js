...
import {
    View, Text, Image, TouchableOpacity, Share, Linking, StatusBar
} from 'react-native';
import {
    shareOnFacebook,
    shareOnTwitter,
...
const ShareChallenge = (props) => {
    ...
    const postOnFacebook = () => {
        ...
        if (props.challengeData.challenge_code)
            facebookParameters.push('quote=' + encodeURI(`Please Install Deadasss app, 1 on 1 videocall with me : ${props.challengeData.deep_linking_url}\r\n\r\nCode is:  ${props.challengeData.challenge_code}\r\n\r\n`));
        const url =
    ...
    const EmailFun = async () => {
        console.log('props.challengeData.deep_linking_url', props.challengeData.deep_linking_url)
        ...
        Linking.openURL(`mailto:?subject=${subject}&body=${encodeURIComponent(message)}`)
            .then((data) => {
    ...
    const instagramFun_old = async () => {
        ...
        RNFetchBlob.config({
            ...
            .then(async (res: any) => {
                ...
                let shareOptions = {
                    title: "Hello Deadass",
                    message: 'Please Install Deadasss app, 1 on 1 videocall with me : ' + '  ' + props.challengeData.deep_linking_url + '  ' + 'Code is:' + '  ' + props.challengeData.challenge_code,
                    url: 'file://' + res.path(),
                    type: 'video/mp4',
    ...
    const tweetNow = async () => {
        ...
        if (props.challengeData.challenge_code)
            facebookParameters.push('text=' + encodeURI(`Please Install Deadasss app, 1 on 1 videocall with me : ${props.challengeData.deep_linking_url}\r\n\r\nCode is:  ${props.challengeData.challenge_code}\r\n\r\n`));
    ...
    return (
        <View style={styles.container}>
            <View style={styles.body}>
                ...
                <TouchableOpacity onPress={() => onPressBack()} style={styles.CrossViewTxt}>
                ...
                <View style={{ alignItems: 'center', paddingTop: 30 }}>
                    ...
                    <Text style={styles.YourChallengetitle}>share it . let's see who's</Text>
                ...
                <View style={styles.ShareIconViewContain}>
                    ...
                    <TouchableOpacity onPress={() => tweetNow()}>
                        <Image source={require('../../../../Assets/twitter.png')} style={{ width: 42, height: 42 }} />
                    ...
                    <TouchableOpacity onPress={() => EmailFun()}>
                        <Image source={require('../../../../Assets/gmail.png')} style={{ width: 42, height: 42 }} />
                        <Text style={styles.ShareTxtStyle}>Email</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => postOnFacebook()}>
                        <Image source={require('../../../../Assets/facebook.png')} style={{ width: 42, height: 42 }} />
