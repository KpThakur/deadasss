          ...
          <View style={{flex: 2, paddingTop: 20}}>
            ...
            <View style={{marginLeft: 9, marginRight: 9, marginBottom: 9}}>
              <Text
                ...
                account between 24-48 hours. Please fill out this form:
              </Text>
            </View>
            ...
            <View style={styles.RoutingNo}>
              ...
              <Text
                style={{
                  ...
                  fontFamily: FONT_FAMILY_TYPE_WRITER,
                  height: 18,
                  color: CHANGE_PASSWORD_COLOUR_CODE,
                  paddingLeft: 15,
                  marginBottom: 5,
                }}>
            ...
            <TouchableOpacity
              onPress={() => props.setProfileModal(!props.ProfileModal)}
              ...
              <View>
                <View style={{flexDirection: 'column'}}>
                  ...
                  <Text
                    ...
                    Choose one of them..( AadharCard, PanCard, PassPort,
                    DrivingLicence )
                  </Text>
                </View>
              </View>
