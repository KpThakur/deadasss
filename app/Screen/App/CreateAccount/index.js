  ...
  async function _CreateAccount() {
    ...
    if (valid) {
      try {
        ...
        formdata.append(
          'business_profile_mcc_account',
          loginData.BusinessProfile,
        );
        ...
        formdata.append(
          'company_address_city_postal_code_account',
          loginData.AddressPostalCd,
        );
        ...
        console.log(
          '🚀 ~ file: index.js ~ line 304 ~ _CreateAccount ~ formdata',
          formdata,
        );
        const {data} = await apiCall(
          'POST',
          ENDPOINTS.createStripeAccount,
          formdata,
        );
        console.log(
          '🚀 ~ file: index.js ~ line 309 ~ _CreateAccount ~ data',
          data,
        );
        if (data.status === 200) {
