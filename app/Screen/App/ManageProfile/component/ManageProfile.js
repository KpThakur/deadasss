...
import { View, Text, Image, TouchableOpacity, Modal, ScrollView, ActivityIndicator, StatusBar, Platform } from 'react-native';
import styles from './styles';
import {
    BLACK_COLOUR_CODE, CHANGE_PASSWORD_COLOUR_CODE, COMMON_BLUE_COLOUR,
    FONT_FAMILY_TYPE_WRITER, WHITE_COLOR_CODE
} from '../../../../Utils/constant';
    ...
    const renderFileUri = () => {
        if (CameraImage !== '') {
            return (
                <View>
                    <Fragment>
                        {props.profileLoader == true ? < ActivityIndicator
                            style={{ marginTop: 10, position: 'absolute', zIndex: 1, right: 0, top: 0, bottom: 0, left: 0, justifyContent: 'center', alignItems: 'center' }}
                            // animating={props.profileLoader}
                            size="large" color={WHITE_COLOR_CODE}
                        />
                            :
                            null}
                        <Image
        ...
        <View style={styles.container}>
            <View style={styles.body}>
                    ...
                    <View style={{ flex: 2, justifyContent: 'center', paddingBottom: 30 }}>
                        ...
                        <View style={{ justifyContent: 'center', alignItems: 'center', paddingBottom: 20 }}>
                            <TouchableOpacity onPress={() => setProfileModal(true)}>
                                {renderFileUri()}
                                <Image style={{ position: 'absolute', right: 0, bottom: 0, height: 35, width: 35 }} source={require('../../../../Assets/edit.png')} />
                            </TouchableOpacity>
                        </View>
                        <Input
                        ...
                        <TouchableOpacity onPress={() => onPressCalender()} style={styles.genderContainer}>
                            <Text style={styles.genderText}>
                    ...
                    <Modal
                     ...
                     >
                        <TouchableOpacity onPress={() => setTimePickerVisible(!timePickerVisible)}
                            ...
                            <TouchableOpacity activeOpacity={0} style={{ backgroundColor: "#f4f8f9", borderRadius: 10, justifyContent: 'center', alignItems: 'center' }}>
                                <Text style={{ fontSize: 18, color: "#a9a9a9", textAlign: "center", marginVertical: 10 }}>
                                ...
                                <TouchableOpacity
                                    ...
                                    style={{ height: 45, width: 130, backgroundColor: CHANGE_PASSWORD_COLOUR_CODE,marginTop:8,marginBottom:8,borderRadius:10,justifyContent:'center',alignItems:'center' }}>
                ...
                >
                    <View style={styles.MainModalView}>
                        <View style={styles.ModalContainer}>
                            <TouchableOpacity onPress={() => setGenderPopUp(false)} style={{ position: 'absolute', right: 20, top: 8 }}>
                                <Text style={{ fontSize: 25, color: BLACK_COLOUR_CODE, fontFamily: FONT_FAMILY_TYPE_WRITER }}>X</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={() => onPressSelectGender(1)}>
                                <Text style={{ fontFamily: FONT_FAMILY_TYPE_WRITER, fontSize: 24, color: Gender === 1 ? COMMON_BLUE_COLOUR : BLACK_COLOUR_CODE }}>Male</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={() => onPressSelectGender(2)}>
                                <Text style={{ fontFamily: FONT_FAMILY_TYPE_WRITER, fontSize: 24, color: Gender === 2 ? COMMON_BLUE_COLOUR : BLACK_COLOUR_CODE }}>Female</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </Modal>
                ...
                >
                    <View style={styles.alertBackground}>
                        <View style={styles.alertBox}>
                            <TouchableOpacity onPress={() => setProfileModal(false)} style={{ position: 'absolute', right: 20, top: 10, width: 40, alignItems: 'flex-end' }}>
