...
import { UPDATE_BTN_COLOUR_CODE, WHITE_COLOR_CODE, CHANGE_PASSWORD_COLOUR_CODE } from '../../../../Utils/constant';
            ...
            <View style={styles.body}>
                ...
                <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                    <View style={styles.MiddleContain}>
                        <TouchableOpacity onPress={() => onPressManageProfile()} style={styles.OptionView}>
                            <View style={styles.ImageContainer}>
                                <Image source={require('../../../../Assets/big_manage.png')} style={{height:30,width:30}} />
                            </View>
                        ...
                        <TouchableOpacity onPress={() => onPressChangePsswrd()} style={styles.OptionView}>
                            <View style={styles.ImageContainer}>
                                <Image source={require('../../../../Assets/big_change.png')} style={{height:30,width:30}}/>
                            </View>
                            <View style={styles.ImgeTextContain}>
                                <Text style={styles.OptionTxtMain}>Change Password</Text>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => onPressActiveList()} style={styles.OptionView}>
                            <View style={styles.ImageContainer}>
                                <Image source={require('../../../../Assets/big_active.png')} style={{height:30,width:30}}/>
                            </View>
                            <View style={styles.ImgeTextContain}>
                                <Text style={styles.OptionTxtMain}>Active Challenge List</Text>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => onPressPaymentDetail()} style={styles.OptionView}>
                            <View style={styles.ImageContainer}>
                                <Image source={require('../../../../Assets/Big_payment.png')} style={{height:30,width:30}} />
                            </View>
                            <View style={styles.ImgeTextContain}>
                                <Text style={styles.OptionTxtMain}>Payment Details</Text>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => onPressAboutUs()} style={styles.OptionView}>
                            <View style={styles.ImageContainer}>
                                <Image source={require('../../../../Assets/big_aboutus.png')} style={{height:30,width:30}}/>
                            </View>
                            <View style={styles.ImgeTextContain}>
                                <Text style={styles.OptionTxtMain}>About Us</Text>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => onPressRating()} style={styles.OptionView}>
                            <View style={styles.ImageContainer}>
                                <Image source={require('../../../../Assets/big_star.png')} style={{height:30,width:30}}/>
                            </View>
                            <View style={styles.ImgeTextContain}>
                                <Text style={styles.OptionTxtMain}>Rate Us</Text>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => onPressContactUs()} style={styles.OptionView}>
                            <View style={styles.ImageContainer}>
                                <Image source={require('../../../../Assets/big_contact.png')} style={{height:30,width:30}} />
                            </View>
                            <View style={styles.ImgeTextContain}>
                                <Text style={styles.OptionTxtMain}>Contact Us</Text>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => onPressTermsAndCondition()} style={styles.OptionView}>
                            <View style={[styles.ImageContainer, { paddingLeft: 2 }]}>
                                <Image source={require('../../../../Assets/729549-200.png')} style={{ height: 40, width: 40, tintColor: '#fff' }} />
                            </View>
                            <View style={styles.ImgeTextContain}>
                ...
                <View style={{ flex: 0.5, paddingBottom: 15, paddingRight: 10, flexDirection: 'row', justifyContent: 'space-between', position: 'absolute', bottom: 0, width: '100%', backgroundColor: CHANGE_PASSWORD_COLOUR_CODE }}>
